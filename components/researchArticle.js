  ...
  return (
    <div className="gap-4 bg-spec-teal-600 p-10 md:p-20">
      <div className="grid grid-cols-1 grid-rows-1 md:grid-cols-2 md:w-4/5 lg:w-3/4  xl:w-2/3 2xl:w-1/2 md:m-auto">
        <div className="text-5xl text-spec-yellow-600 font-bold space-y-5 pb-10 lg:ml-20 lg:p-24 md:pl-30 xl:m-auto">
          <p>Research</p>
          <p>Methods</p>
          <p>Article</p>
        </div>
        <div className=" py-10 md:py-12 lg:py-14">
          ...
          <div className="text-white">
            ...
            <p className="font-bold pt-10">Submission Date: TBD</p>
          </div>
        </div>
