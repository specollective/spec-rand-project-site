...
function MeepleLoading() {
  ...
  const loadingColOne = ['Identify goals & objectives', 'Literature review on research', 'Selection of game topic', 'Selection of game mechanic', 'Produced a development process']
