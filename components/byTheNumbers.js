...
export default function ByTheNumbers() {
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-3 bg-spec-black-600 md:justify-items-center items-center p-10 md:p-20 md:w-4/5 xl:w-1/2 md:m-auto">
			...
			<StatBox
				className="row-start-2 col-start-1 row-span-2 my-4 md:my-0"
