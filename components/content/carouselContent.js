...
export const reflectionObjList = [
    ...
    },
    {
      ...
      image: victoria,
      quote:
        "Working on the SPEC team on multiple RAND projects has given me so much insight into being a better developer and advocate for social and racial equity. As a junior developer, I was eager to quickly start building systems with software and learn as much as possible. I was able to build out microcredential courses on an open-source learn management system and contribute to building the impact website with Of Ash and Fire. I quickly understood the importance of mindfulness of unconscious biases and how to build systems that are inclusive to multiple end-users. I also enjoyed having regular meetings with Dr. Rhianna Rogers and other Research Associates to have an open conversation about our perspectives.",
      title: "Research Associate / Software Engineer",
    },
    {
      name: "Alicia Bong",
  ...
  export const microcredentialsObjList = [
    {
      name: "Yoline Banerjee",
      image: yoline,
      quote:
