...
function RAprofile() {
  ...
  const profileData = [
    ...
    { fullName: 'Menoukha Robin Case', firstName: 'Menoukha', title: 'Content Advisor', pic: Menouka, alt: 'Menouka pic', linkedInLink: 'https://www.linkedin.com/in/menoukha-robin-case-982a611b4/', text: 'Dr. Menoukha Robin Case is a SUNY Professor Emerita who holds an MA in Women’s & Gender Studies, an MA in Creative Writing, and a Ph.D. in English from SUNY University at Albany. Her dissertation addresses African Diaspora literature via Yoruba philosophy; her post-graduate work emphasizes Indigenous Studies. Academic publications include Introduction to Feminist Thought and Action (Routledge) and Weaving the Legacy: Remembering Paula Gunn Allen (West End Press). Creative publications include “Bead by Bead” in Talking Stick Native Arts Quarterly and “Burying Grandma” in Tidal Basin Review, awarded the Editors’ Prize for Best Prose in 2011. She serves on the boards of the Hamilton Hill Arts Center and the Ndakinna Education Center and on the Steering Committee of SPEC.', projects: [gamingProj, impactProj],
    },
    { fullName: 'Nan Eileen Mead', firstName: 'Nan', title: 'Research Lead', pic: Nan, alt: 'Nan pic', linkedInLink: 'https://www.linkedin.com/in/naneileenmead/', text: 'Research Lead at Sustainable Progress & Equality Collective (SPEC) and Co-Editor of JoER. A longtime education advocate, Ms. Mead was twice elected by the NYS Legislature to serve as the Manhattan member of the Board of Regents, which oversees the State Education Department. Ms. Meads research focus is on diversity, equity, and inclusion in educational settings and in public policy.', projects: [journalProj, impactProj],
    },
    { fullName: 'Ollie Oliver', firstName: 'Ollie', title: 'Title', pic: Ollie, alt: 'Ollie pic', linkedInLink: 'https://www.linkedin.com/in/naneileenmead/', text: 'Vitae aliquam turpis et, donec auctor posuere sagittis. Placerat nibh facilisis nulla placerat amet. Eros faucibus fringilla rhoncus elit sed dolor. Consequat condimentum praesent sem diam felis facilisis. Tristique sit aliquet ut in gravida vulputate porttitor et. Ultrices libero, neque gravida amet, erat odio maecenas. Eget aliquet diam nisl, potenti elit. Vestibulum lacus a dictumst facilisi elit diam dui at at. Magna lorem et accumsan, venenatis. Nullam vitae risus tincidunt sit suspendisse.', projects: [expressionsProj],
    },
    { fullName: 'Victoria Lo', firstName: 'Victoria', title: 'Research Associate / Software Engineer', pic: Victoria, alt: 'Victoria pic', linkedInLink: 'https://www.linkedin.com/in/victoria-lo/', text: 'Victoria Lo graduated from San Jose State University with a B.S. in Health Science Administration. She has spent six years in Operations for health start-ups. She is curious by nature and fueled by the need to help others. Using websites, applications, and other technologies, she went from helping thousands of people in one clinic to millions across the nation. With that scale of impact, she knew coding would be her next journey. Victoria then completed a full-stack software engineering program to havedirect experience in building products that scale. With grit and armed with new skills, she is ready for a new challenge.', projects: [microCredentialProj, impactProj],
    },
    { fullName: 'Yoline Banerjee', firstName: 'Yoline', title: 'Research Associate / Software Engineer', pic: Yoline, alt: 'Yoline pic', linkedInLink: 'https://www.linkedin.com/in/yolineb/', text: 'Yoline Banerjee is a research associate for SPEC. With a B.A. in Sociology and a minor in Education from UC Berkeley, Yoline has worked in various educational roles. She then went into Health Services by managing COVID testing sites. After experiencing different programs and web applications that had her thinking, “there has to be a better way,” she pivoted into the tech industry and graduated from Hackbright’s software engineering program. She is excited to combine her passion for working with the community and developing her coding skills to build systems that will help people learn, grow, and thrive.', projects: [microCredentialProj, impactProj],
    },
    { fullName: 'Lu Daley', firstName: 'Lu', title: 'Research Associate / Software Engineer', pic: Lu, alt: 'Lu pic', linkedInLink: 'https://www.linkedin.com/in/ludaley/', text: 'Lu Daley is a research associate/software developer at SPEC. Lu’s research involves researching, creating, and testing full-stack solutions with accessibility in mind. His team is currently building a front-end design system, a full-stack learning management system, and contributing to other open source social justice, economic growth, and environmental sustainability projects.', projects: [gamingProj],
    },
  ]
